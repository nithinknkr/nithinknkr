...
- 🎓 Final-year **B.Tech in Computer Science (Data Science)** @ BVRIT, Narsapur — CGPA **8.80**, graduating 2026
- 💼 Backend Developer Intern @ **Risk Guard Enterprise** — shipped 6 production REST APIs for a live healthcare SaaS platform
- 🤖 Focused on **Agentic AI, LLM systems, and RAG pipelines**, with a strong foundation in production-grade backend engineering
- 🏆 Runner-up, **Code Breakers** @ Promethean 2024
- 🔭 Currently building AI systems designed to actually ship and run in production — not just live in a notebook
- 📫 Reach me at **konudulanithin234@gmail.com**
...
<img src="https://skillicons.dev/icons?i=py,java,django,fastapi,nodejs,express,mongodb,postgres,pytorch,tensorflow,opencv,git,github,docker,postman,jupyter&theme=dark" />
...
**🔧 [openenv-sql-repair](https://github.com/nithinknkr/openenv-sql-repair)**
<br/>
...
<br/>
`Python` `Reinforcement Learning` `PyTorch` `DQN`

</td>
<td width="50%" valign="top">

**📋 [TeamSync](https://github.com/nithinknkr/TeamSync)**
<br/>
Full-stack project management backend with real-time individual and group chat via Socket.IO, JWT-secured REST APIs, and automated email workflows (Nodemailer) for invites and deadline alerts.
<br/>
...
**🤟 [Deaf-unit-hub](https://github.com/nithinknkr/Deaf-unit-hub)**
<br/>
ASL learning platform backend integrating an LSTM + MediaPipe deep learning pipeline recognizing 2,000+ signs at 88% accuracy, with secure JWT auth and MongoDB-based user progress tracking.
<br/>
`Node.js` `LSTM` `MediaPipe` `MongoDB` `JWT`

</td>
<td width="50%" valign="top">

**🌱 [BioMass-_App](https://github.com/nithinknkr/BioMass-_App)**
<br/>
Multi-modal pasture biomass predictor (ConvNeXt Tiny + MLP), R² = 0.88, cutting manual field assessment time by 75–80%.
<br/>
`PyTorch` `ConvNeXt` `Streamlit`
